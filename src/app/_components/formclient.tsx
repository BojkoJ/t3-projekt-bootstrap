				...
				>
					<div className="row mt-4">
						<div className="col-2">
							<h5>Termín</h5>
							<div className="mb-2">
								<label htmlFor="idTerminu" className="form-label">
									ID Termínu:
								</label>
								<input
									name="id_appointment"
							...
							<div className="mb-2">
								<label htmlFor="datumTerminu" className="form-label">
									Datum:
								</label>
							...
							<div className="mb-2">
								<label htmlFor="casTerminu" className="form-label">
									Čas:
								</label>
								<input
									name="time"
						...
						<div className="col-2">
							<h5>Zákazník</h5>
							<div className="mb-2">
								<label htmlFor="idZakaznika" className="form-label">
									ID Zákazníka:
								</label>
								<input
									type="text"
									...
									readOnly
									defaultValue={appointment?.id_customer ?? ""}
								/>
							</div>
							<div className="mb-2">
								<label htmlFor="jmenoZakaznika" className="form-label">
									Jméno:
								</label>
								<input
									type="text"
							...
							<div className="mb-2">
								<label htmlFor="prijmeniZakaznika" className="form-label">
									Příjmení:
								</label>
								<input
									type="text"
						...
						<div className="col-2">
							<h5>Návrh</h5>
							<div className="mb-2">
								<label htmlFor="idNavrhu" className="form-label">
									ID Návrhu:
								</label>
								<input
									type="text"
							...
							<div className="mb-2">
								<label htmlFor="nazevNavrhu" className="form-label">
									Název:
								</label>
								<input
									type="text"
						...
						<div className="col-2">
							<h5>&nbsp;</h5>
							<div className="mb-2">
								<label htmlFor="delkaVytetovani" className="form-label">
									Délka vytetování:
								</label>
								<input
									type="text"
				...
				>
					<div className="row mt-4">
						...
						<div className="col-3">
							...
							<div className="mb-2">
								<label htmlFor="emailZakaznika" className="form-label">
									Email:
								</label>
								<input
									name="email"
							...
							<div className="mb-2">
								<label htmlFor="telefonZakaznika" className="form-label">
									Telefon:
								</label>
								<input
									name="phone"
				...
				>
					<div className="row mt-4">
						...
						<div className="col-3">
							...
							<div className="mb-2">
								<label htmlFor="sirkaNavrhu" className="form-label">
									Šířka:
								</label>
								<input
									name="width"
							...
							<div className="mb-2">
								<label htmlFor="vyskaNavrhu" className="form-label">
									Výška:
								</label>
								<input
									name="height"
							...
							<div className="mb-2">
								<label htmlFor="umisteniNavrhu" className="form-label">
									Umístění:
								</label>
								<input
									name="placement"
			...
			<div className="row mt-4 mb-4">
				<div className="col text-center">
					...
					<Modal show={showModal} onHide={handleClose}>
						...
						<Modal.Body>
							Tlačítkem <span className="fw-bold ">Nový záznam</span> vyčistíte
							vstupní pole, aby bylo možné zadat nové hodnoty.
							<br /> Tlačítkem <span className="fw-bold ">Uložit</span> uložíte
							záznam do seznamu
							<br />
							Tvůrce: Jan Bojko, Login: BOJ0043.
							<br />
							<br />
							Program: Projekt Bootstrap do předmětu URO. Slouží jako evidence
							termínů zákazníků pro tetovací salón.
						</Modal.Body>
						<Modal.Footer>
